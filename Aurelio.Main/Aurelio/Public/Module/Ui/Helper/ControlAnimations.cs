        ...
        new Animation
        {
            ...
            Children =
            {
                new KeyFrame()
                {
                    Setters =
                    {
                        new Avalonia.Styling.Setter { Property = Control.MarginProperty, Value = new Thickness(currentMargin.Left, currentMargin.Top, currentMargin.Right, currentMargin.Bottom)},
                    },
                ...
                new KeyFrame()
                {
                    Setters =
                    {
                        new Avalonia.Styling.Setter { Property = Control.MarginProperty, Value = new Thickness(currentMargin.Left, currentMargin.Top - 8, currentMargin.Right, currentMargin.Bottom +8)},
                    },
                ...
                new KeyFrame()
                {
                    Setters =
                    {
                        new Avalonia.Styling.Setter { Property = Control.MarginProperty, Value = new Thickness(currentMargin.Left, currentMargin.Top-2, currentMargin.Right, currentMargin.Bottom +2)},
                    },
