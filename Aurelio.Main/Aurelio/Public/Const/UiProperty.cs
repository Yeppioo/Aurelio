...
public class UiProperty : ReactiveObject
{
    ...
    public static readonly IMultiValueConverter ContainerWidthDivider = new ContainerWidthDividerConverter();
    public static readonly IValueConverter ContainerToColumnsConverter = new ContainerToColumnsConverter();
