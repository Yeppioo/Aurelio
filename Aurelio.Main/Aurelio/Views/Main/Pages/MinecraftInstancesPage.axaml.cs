...
public partial class MinecraftInstancesPage : PageMixModelBase, IAurelioTabPage
{
    ...
    public string SearchText
    {
        ...
        set
        {
            ...
            MinecraftInstancesHandler.Search(SearchText);
        }
    }
    ...
    private void BindingEvent()
    {
        ...
        {
            if (e.Key == Key.Enter) MinecraftInstancesHandler.Search(SearchText);
        };
        SearchButton.Click += (_, _) => { MinecraftInstancesHandler.Search(SearchText); };
