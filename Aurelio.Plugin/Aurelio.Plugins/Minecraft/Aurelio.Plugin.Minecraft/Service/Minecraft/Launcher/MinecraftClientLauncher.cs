...
public partial class MinecraftClientLauncher
{
    public static async Task Launch(RecordMinecraftEntry entry, Control sender)
    {
        ...
        if (MinecraftPluginData.MinecraftPluginSettingEntry.MinecraftInstanceSortMethod == MinecraftInstanceSortMethod.LastPlayed)
        {
        ...
        {
            case Classes.Enum.Setting.AccountType.Offline:
                ...
                break;
            case Classes.Enum.Setting.AccountType.Microsoft:
                var profile =
                ...
                break;
            case Classes.Enum.Setting.AccountType.ThirdParty:
                ...
                try
                {
                    ...
                    process.Exited += async (_, arg) =>
                    {
                        await Dispatcher.UIThread.InvokeAsync(async () =>
                        {
                            ...
                            if (MinecraftPluginData.MinecraftPluginSettingEntry.WindowVisibility !=
                                Classes.Enum.Setting.WindowVisibility.AfterLaunchMakeMinimize)
                            {
                        ...
                        Dispatcher.UIThread.Invoke(() =>
                        {
                            switch (MinecraftPluginData.MinecraftPluginSettingEntry.WindowVisibility)
                            {
                                ...
                                case Classes.Enum.Setting.WindowVisibility.AfterLaunchMinimizeAndShowWhenGameExit:
                                    ...
                                    break;
                                case Classes.Enum.Setting.WindowVisibility.AfterLaunchHideAndShowWhenGameExit:
                                    if (sender.GetVisualRoot() is Window window1)
                                    {
                                        window1.Hide();
                                    }
                                    ...
                                    break;
                                case Classes.Enum.Setting.WindowVisibility.AfterLaunchKeepVisible:
                                default:
                                    break;
                            }
                        });
